package com.ly.pushlibrary.client;

import android.util.Log;


import com.ly.pushlibrary.msg.InitMsg;
...
public class NettyClientBootstrap {
    ...
    private void start() throws InterruptedException {
        ...
        if (future.isSuccess()) {
            ...
            initMsg.setApp("ANDROID");
            initMsg.setDevice("HUAWEI-001");
            socketChannel.writeAndFlush(initMsg);
            Log.e("NettyClientBootstrap",
                "start(NettyClientBootstrap.java:63)"+socketChannel.toString());
     ...
     * @用于：
     */
    public static void init(int port, String host, String app, String device) throws Exception {
